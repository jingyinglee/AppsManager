...
public class DeviceProfile {
    ...
    private void updateAvailableDimensions(DisplayMetrics dm, Resources res) {
        ...
        //这里没有完全理解,不知道有没有改错了
        if (isLandscape){
            maxHeight = (availableHeightPx - workspacePadding.top - workspacePadding.bottom);
        }else{
            maxHeight = (availableWidthPx - 12 - workspacePadding.bottom);
        }
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources res,
        ...
        hotseatCellHeightPx = iconSizePx + iconTextSizePx;
    ...
    public void layout(Launcher launcher) {
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                lp.bottomMargin = hotseatBarHeightPx + pageIndicatorHeightPx/2;
