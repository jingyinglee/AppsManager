...
public class UninstallDropTarget extends ButtonDropTarget {
    ...
    private static boolean isIgnoreUninstallApp(Context context, String packageName){
        ...
        //先判断是不是自己本身
        if(packageName.equals( "com.abylee."+ FeaturesConfig.channel+".appsmanager" )){
        ...
        if(sIgnoreUninstallAppsList == null){
            ...
            //解析xml配置
            try {
                XmlResourceParser xmlResourceParser = context.getResources().getXml(R.xml.ignore_uninstall_apps);
